...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   resolver_filler_up.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jsivanes <jsivanes42@gmail.com>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/08/23 18:15:14 by jsivanes          #+#    #+#             */
/*   Updated: 2016/08/31 19:24:04 by jsivanes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			resolver_filler_up(t_fil *fil, t_piece *piece, int m_vil)
{
	...
	piece->pos_y = (ret == 0) ? -1 : piece->pos_y - 1;
	while (fil->map[++piece->pos_y] && ret == 0)
	{
		piece->pos_x = -1;
		while (fil->map[piece->pos_y][++piece->pos_x])
		{
